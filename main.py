...
EVENT_ID = "33267269"
EVENT_NAME = "Test Long Ids 2024"

VIDEO_ITEM_ID = 177609644
PROVIDER_ID = Provider.IMG_GOLF.value
PROVIDER_EVENT_ID = 846
SPORT_ID = Sport.GOLF.value
...
(EVENT_ID,NAME,EVENT_TYPE_ID,VENUE,OPEN_DATE,COMPETITION_NAME,DATA_FOR_MAPPING_UPDATED_AT,IN_PLAY) VALUES
    ({EVENT_ID}, '{EVENT_NAME}', '{EVENT_TYPE_ID}', null, CURRENT_TIMESTAMP - INTERVAL '1' HOUR, '{EVENT_NAME}', CURRENT_TIMESTAMP, 'Y')
;
    """
...
VALUES
    ({VIDEO_ITEM_ID}, {PROVIDER_ID}, '{PROVIDER_EVENT_ID}', '{PROVIDER_EVENT_NAME}', '{PROVIDER_SPORTS_TYPE}', CURRENT_TIMESTAMP - INTERVAL '1' HOUR, null, '{PROVIDER_COMPETITION}',
     null, null, null, null, null, null, null,
     CURRENT_TIMESTAMP - INTERVAL '1' HOUR, null, null, null, null, null, {BETFAIR_SPORTS_ID},
...
VALUES(1, {VIDEO_ITEM_ID}, '{EVENT_ID}', NULL, NULL, '1', 3);
    """
...
VALUES
    ({VIDEO_ITEM_ID}, {PROVIDER_ID}, {EVENT_ID}, 'EVENT:{EVENT_ID}', '{EVENT_NAME}', 'N','A', 2, 'ie2-vhs01b-nxt.nxt.betfair', CURRENT_TIMESTAMP, 'I', CURRENT_TIMESTAMP + INTERVAL '1' HOUR)
;
"""
...
SET PROVIDER_ID = {PROVIDER_ID},
    ...
    PROVIDER_SPORTS_TYPE = {PROVIDER_SPORTS_TYPE},
